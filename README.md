...
- The **Pots tab** detects a fresh North Horn instance from the public-content director start time and counts down to the first expected spawn: **Daylight Pottery (north)** at approximately 20 minutes.
